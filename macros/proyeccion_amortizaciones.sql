{% macro proyeccion_amortizaciones(credit_id, fecha_corte, saldo, cuota, tasa, plazo) %}
...
{%- for i in range(condiciones_credito['plazo']) -%}
    ...
    {%- if i == 0 -%}
        ...
        {%- set diccionario_resultados = { 'mes_{}'.format(i) : {'credit_id': credit_id,'fecha_corte': fecha_corte,'saldo': saldo|round(1), 'cuota': cuota, 'tasa': tasa, 'intereses' : intereses|round(1), 'amortizacion': amortizacion|round(1), 'plazo': plazo}} -%}
...
{{ return(proyeccion_amortizaciones)}}
